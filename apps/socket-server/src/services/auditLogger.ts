...
export class AuditLogger {
   ...
   */
  public logEvent(eventType: AuditEventType, metadata: AuditEventMetadata): void {
    try {
   ...
   */
  public logAuthFailed(reason: string, metadata: AuditEventMetadata = {}): void {
   ...
   */
  public logSocketAuthSuccess(socketId: string, uid: string, role: string): void {
   ...
   */
  public logSocketAuthFailed(socketId: string, reason: string, metadata: AuditEventMetadata = {}): void {
